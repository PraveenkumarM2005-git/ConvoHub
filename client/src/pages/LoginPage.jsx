// ============================================================
// LoginPage — Dark themed login with ConvoHub branding
// Matches the reference UI: "Authorize Connection" style
// ============================================================
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center mb-6 md:mb-8 text-center">
          ...
          <div className="relative w-16 h-16 rounded-2xl flex items-center justify-center mb-4 bg-[#111118] border border-cyan-500/30 text-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke="url(#convoGradientLogin)"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            >
              <defs>
                <linearGradient id="convoGradientLogin" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <p className="text-xs tracking-[0.3em] uppercase text-dark-200 mt-1">
            Architectural Messaging Protocol
          </p>
        </div>
        ...
        <div className="glass-card w-full p-5 sm:p-8 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-sm text-dark-200 mb-6">
            Enter your credentials to access the encrypted interface.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-xs tracking-[0.15em] uppercase text-dark-200 font-medium">
                  Cryptographic Key
                </label>
                <button
                  type="button"
          ...
          <div className="mt-6 pt-4 border-t border-dark-600 text-center">
            ...
            <div className="flex items-center justify-center gap-4 text-xs text-dark-300">
              <span className="hover:text-dark-100 cursor-pointer transition-colors uppercase tracking-wider">
                Privacy Shield
              </span>
              <span className="hover:text-dark-100 cursor-pointer transition-colors uppercase tracking-wider">
                System Status
        ...
        <div className="hidden sm:flex fixed bottom-6 left-6 items-center gap-2 px-3 py-2 rounded-lg bg-[#14151a] border border-[#22232e]">
          ...
          <span className="text-[10px] text-dark-200 tracking-[0.1em] uppercase">
